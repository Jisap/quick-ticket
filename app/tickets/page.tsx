...
const TicketsPage = async() => {
  ...
  return (
    <div className="min-h-screen bg-blue-50 p-8">
      <h1 className="h1 text-3xl font-bold text-blue-600 mb-8 text-center">
        Support Tickets
      </h1>
      {tickets.length === 0 
        ...
        : (
          <div className="space-y-4 max-w-3xl mx-auto">
            {tickets.map((ticket) => (
              <div className="flex justify-between items-center bg-white rounded-lg shadow border-gray-200 p-6" key={ticket.id}>
                {/* left */}
                <div>
